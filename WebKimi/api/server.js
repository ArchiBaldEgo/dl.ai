/**
 * HTTP API сервер бот-пула для Web Kimi.
 *
 * Предоставляет два эндпоинта:
 * - POST /v1/chat/completions — OpenAI-совместимый API (для model_clients/web_kimi.py).
...
function createServer({ botManager, config, logger }) {
  ...
  // Django health check when Web Kimi is detected as down.
